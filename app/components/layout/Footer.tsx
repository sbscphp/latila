...
const Footer = () => {
  return (
    <footer className="text-white py-12" style={{ backgroundColor: "#101828" }}>
    ...
    <p className="text-[#98A2B3] text-base leading-relaxed">
      ...
      Latila Ventures Limited.
          ...
          <div className="flex items-center space-x-4">
            <a
              href="https://twitter.com/latilaconsulting"
            ...
            <a
              href="https://instagram.com/latilaconsulting"
              className="text-[#98A2B3] hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://youtube.com/@latilaconsulting"
              className="text-[#98A2B3] hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://linkedin.com/company/latilaconsulting"
              className="text-[#98A2B3] hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
